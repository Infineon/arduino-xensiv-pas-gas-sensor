...
XENSIV_PAS_GASIno* create_sensor(GasType_t type, TwoWire* wire, uint8_t intPin) {
...
XENSIV_PAS_GASIno* create_sensor(GasType_t type, HardwareSerial* serial, uint8_t intPin) {
    if (type == GAS_TYPE_CO2) {
