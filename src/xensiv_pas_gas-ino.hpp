...
class XENSIV_PAS_GASIno
{
    public:
        ...
        static constexpr uint8_t       unusedPin = 0xFFU; /**< Unused pin */        
                ...
                XENSIV_PAS_GASIno (TwoWire * wire = &Wire, uint8_t intPin = unusedPin);
                XENSIV_PAS_GASIno (HardwareSerial * serial, uint8_t intPin = unusedPin);
                ~XENSIV_PAS_GASIno();
        ...
        virtual const char* getGasConcentrationUnitStr() const = 0; // Pure virtual
